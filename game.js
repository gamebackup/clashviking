...
(function(b, c) {
  function d(b, D, d) {
    if (d === c && 1 === b.nodeType)
      if (d = "data-" + D.replace(tc, "-$1").toLowerCase(), d = b.getAttribute(d), "string" == typeof d) {
        try {
          d = "true" === d ? !0 : "false" === d ? !1 : "null" === d ? null : +d + "" === d ? +d : uc.test(d) ? f.parseJSON(d) : d
        } catch (q) {}
        f.data(b, D, d)
      } else d = c;
    return d
  ...
  function s(b, c, d) {
    c = c || 0;
    if (f.isFunction(c)) return f.grep(b, function(b, A) {
      return !!c.call(b, A, b) === d
    });
    if (c.nodeType) return f.grep(b, function(b) {
      return b === c === d
    });
    if ("string" == typeof c) {
      var q = f.grep(b, function(b) {
        return 1 === b.nodeType
      });
      if (vc.test(c)) return f.filter(c, q, !d);
      c = f.filter(c, q)
    }
    ...
    if (1 === c.nodeType && f.hasData(b)) {
      ...
      if (l)
        for (d in delete p.handle, p.events = {}, l) {
          q = 0;
          for (e = l[d].length; q < e; q++) f.event.add(c, d, l[d][q])
        }
      p.data && (p.data = f.extend({}, p.data))
    }
  }
  ...
  function z(b, c) {
    ...
    1 === c.nodeType && (c.clearAttributes && c.clearAttributes(), c.mergeAttributes && c.mergeAttributes(b), d = c.nodeName.toLowerCase(), "object" === d ? (c.parentNode && (c.outerHTML = b.outerHTML), f.support.html5Clone && b.innerHTML && !f.trim(c.innerHTML) &&
      (c.innerHTML = b.innerHTML)) : "input" === d && zb.test(b.type) ? (c.defaultChecked = c.checked = b.checked, c.value !== b.value && (c.value = b.value)) : "option" === d ? c.selected = b.defaultSelected : "input" === d || "textarea" === d ? c.defaultValue = b.defaultValue : "script" === d && c.text !== b.text && (c.text = b.text), c.removeAttribute(f.expando))
  }
  ...
  function n(b, c) {
    if (c in b) return c;
    for (var d = c.charAt(0).toUpperCase() + c.slice(1), f = c, e = Ab.length; e--;)
      if (c = Ab[e] + d, c in b) return c;
    return f
  }
  ...
  function y(b, c) {
    for (var d, q, e = [], p = 0, l = b.length; p < l; p++) d = b[p], d.style && (e[p] = f._data(d, "olddisplay"), c ? (!e[p] && "none" === d.style.display && (d.style.display = ""), "" === d.style.display && u(d) && (e[p] = f._data(d, "olddisplay", xa(d.nodeName)))) : (q = O(d, "display"), !e[p] &&
      "none" !== q && f._data(d, "olddisplay", q)));
    for (p = 0; p < l; p++)
  ...
  function L(b, c, d) {
    return (b = wc.exec(c)) ? Math.max(0, b[1] - (d || 0)) + (b[2] || "px") : c
  }

  function P(b, c, d, q) {
    c = d === (q ? "border" : "content") ? 4 : "width" === c ? 1 : 0;
    for (var e = 0; 4 > c; c += 2) "margin" === d && (e += f.css(b, d + ca[c], !0)), q ? ("content" === d && (e -= parseFloat(O(b, "padding" + ca[c])) || 0), "margin" !== d && (e -= parseFloat(O(b, "border" + ca[c] + "Width")) || 0)) : (e +=
      parseFloat(O(b, "padding" + ca[c])) || 0, "padding" !== d && (e += parseFloat(O(b, "border" + ca[c] + "Width")) || 0));
    return e
  }
  ...
  function K(b, c, d) {
    var q = "width" === c ? b.offsetWidth : b.offsetHeight,
      e = !0,
      p = f.support.boxSizing && "border-box" === f.css(b, "boxSizing");
    if (0 >= q || null == q) {
      q = O(b, c);
      if (0 > q || null == q) q = b.style[c];
      if (ya.test(q)) return q;
      e = p && (f.support.boxSizingReliable || q === b.style[c]);
      q = parseFloat(q) || 0
    }
    return q + P(b, c, d || (p ? "border" : "content"), e) + "px"
  }

  function xa(b) {
    if (Ya[b]) return Ya[b];
    var c = f("<" + b + ">").appendTo(C.body),
      d = c.css("display");
    c.remove();
    if ("none" === d || "" === d) {
  ...
  function za(b, c, d, q) {
    var e;
    if (f.isArray(c)) f.each(c, function(c, D) {
      d || xc.test(b) ? q(b, D) : za(b + "[" + ("object" == typeof D ? c : "") + "]",
        D, d, q)
    });
    else if (!d && "object" === f.type(c))
      for (e in c) za(b + "[" + e + "]", c[e], d, q);
    else q(b, c)
  }
  ...
  function I(b) {
    return function(c, d) {
      ...
      var q, e, p = c.toLowerCase().split(da),
        l = 0,
        g = p.length;
      if (f.isFunction(d))
        for (; l < g; l++) q = p[l], (e = /^\+/.test(q)) && (q = q.substr(1) || "*"), q = b[q] = b[q] || [], q[e ? "unshift" : "push"](d)
    }
  }

  function T(b, D, d, f, e, p) {
    e = e || D.dataTypes[0];
    p = p || {};
    p[e] = !0;
    var l;
    e = b[e];
    for (var g = 0, n = e ? e.length : 0, j = b === $a; g < n && (j || !l); g++) l = e[g](D, d, f), "string" == typeof l && (!j || p[l] ? l =
      c : (D.dataTypes.unshift(l), l = T(b, D, d, f, l, p)));
    return (j || !l) && !p["*"] && (l = T(b, D, d, f, "*", p)), l
  }

  function Bb(b, d) {
    var v, q, e = f.ajaxSettings.flatOptions || {};
    for (v in d) d[v] !== c && ((e[v] ? b : q || (q = {}))[v] = d[v]);
    q && f.extend(!0, b, q)
  }
  ...
  function Cb(b, c, d) {
    var q, e = 0,
      ...
      g = function() {
        for (var c = Ba || ra(), c = Math.max(0, n.startTime + n.duration - c),
            d = 1 - (c / n.duration || 0), D = 0, v = n.tweens.length; D < v; D++) n.tweens[D].run(d);
        return l.notifyWith(b, [n, d, c]), 1 > d && v ? c : (l.resolveWith(b, [n]), !1)
      },
      n = l.promise({
        elem: b,
        props: f.extend({}, c),
        ...
        createTween: function(c, d) {
          var D = f.Tween(b, n.opts, c, d, n.opts.specialEasing[c] || n.opts.easing);
          return n.tweens.push(D), D
        },
        stop: function(c) {
          for (var d = 0, D = c ? n.tweens.length : 0; d < D; d++) n.tweens[d].run(1);
          return c ? l.resolveWith(b, [n, c]) : l.rejectWith(b, [n, c]), this
        }
      });
    c = n.props;
    ...
    var j, m, u, y;
    for (q in c)
      if (j = f.camelCase(q), m = d[j], u = c[q], f.isArray(u) && (m = u[1], u = c[q] = u[0]), q !== j && (c[j] = u, delete c[q]), (y = f.cssHooks[j]) && "expand" in y)
        for (q in u = y.expand(u), delete c[j], u) q in c || (c[q] = u[q], d[q] = m);
      else d[j] = m;
    for (; e < p; e++)
      if (q = Ca[e].call(n, b, c, n.opts)) return q;
    var s = n;
    f.each(c, function(b, c) {
      for (var A = (sa[b] || []).concat(sa["*"]), d = 0, D = A.length; d < D && !A[d].call(s, b, c); d++);
    });
    return f.isFunction(n.opts.start) &&
      n.opts.start.call(b, n), f.fx.timer(f.extend(g, {
        anim: n,
        queue: n.opts.queue,
        elem: b
  ...
  function Da(b, c) {
    var d, f = {
      ...
      e = 0;
    for (c = c ? 1 : 0; 4 > e; e += 2 - c) d = ca[e], f["margin" + d] = f["padding" + d] = b;
  ...
  f.fn = f.prototype = {
    ...
    init: function(b, d, v) {
      ...
      if ("string" == typeof b) {
        "<" === b.charAt(0) &&
          ">" === b.charAt(b.length - 1) && 3 <= b.length ? q = [null, b, null] : q = Gc.exec(b);
        if (q && (q[1] || !d)) {
          if (q[1]) return d = d instanceof f ? d[0] : d, e = d && d.nodeType ? d.ownerDocument || d : C, b = f.parseHTML(q[1], e, !0), Hb.test(q[1]) && f.isPlainObject(d) && this.attr.call(b, d, !0), f.merge(this, b);
          if ((d = C.getElementById(q[2])) && d.parentNode) {
            if (d.id !== q[2]) return v.find(b);
            this.length = 1;
            this[0] = d
          }
  ...
  f.extend = f.fn.extend = function() {
    var b, d, v, q, e, p, l = arguments[0] || {},
      g = 1,
      n = arguments.length,
      j = !1;
    "boolean" == typeof l && (j = l, l = arguments[1] || {}, g = 2);
    "object" != typeof l && !f.isFunction(l) && (l = {});
    for (n === g && (l = this, --g); g < n; g++)
      if (null != (b = arguments[g]))
        for (d in b) v = l[d], q = b[d], l !== q && (j && q && (f.isPlainObject(q) || (e = f.isArray(q))) ? (e ? (e = !1, p = v && f.isArray(v) ? v : []) : p = v && f.isPlainObject(v) ? v : {}, l[d] = f.extend(j, p, q)) : q !== c && (l[d] = q));
    return l
  };
  f.extend({
    noConflict: function(c) {
      return b.$ ===
        f && (b.$ = Cc), c && b.jQuery === f && (b.jQuery = Bc), f
    },
    isReady: !1,
    readyWait: 1,
    ...
    parseHTML: function(b, c, d) {
      ...
      return !b || "string" != typeof b ? null :
        ("boolean" == typeof c && (d = c, c = 0), c = c || C, (q = Hb.exec(b)) ? [c.createElement(q[1])] : (q = f.buildFragment([b], c, d ? null : []), f.merge([], (q.cacheable ? f.clone(q.fragment) : q.fragment).childNodes)))
    },
    ...
    parseXML: function(A) {
      ...
      try {
        b.DOMParser ?
          (v = new DOMParser, d = v.parseFromString(A, "text/xml")) : (d = new ActiveXObject("Microsoft.XMLDOM"), d.async = "false", d.loadXML(A))
      } catch (q) {
        d = c
      }
      return (!d || !d.documentElement || d.getElementsByTagName("parsererror").length) && f.error("Invalid XML: " + A), d
    },
    noop: function() {},
    globalEval: function(c) {
      c && Ec.test(c) && (b.execScript || function(c) {
        b.eval.call(b, c)
      })(c)
    },
    ...
    each: function(b, d, v) {
      var q, e = 0,
        p = b.length,
        l = p === c || f.isFunction(b);
      if (v)
        if (l)
          for (q in b) {
            if (!1 === d.apply(b[q], v)) break
          } else
            for (; e < p && !1 !== d.apply(b[e++], v););
        else if (l)
        for (q in b) {
          if (!1 === d.call(b[q], q, b[q])) break
        } else
          for (; e < p && !1 !== d.call(b[e], e, b[e++]););
      return b
    },
    ...
    makeArray: function(b, c) {
      ...
      return null != b && (d = f.type(b), null == b.length || "string" === d || "function" ===
        d || "regexp" === d || f.isWindow(b) ? Fb.call(q, b) : f.merge(q, b)), q
    },
    ...
    grep: function(b, c, d) {
      var f, e = [],
        p = 0,
        l = b.length;
      for (d = !!d; p < l; p++) f = !!c(b[p], p), d !== f && e.push(b[p]);
      return e
    },
    map: function(b, d, v) {
      var q,
      ...
      if (b instanceof f || g !== c && "number" == typeof g && (0 < g && b[0] && b[g - 1] || 0 === g || f.isArray(b)))
        for (; l < g; l++) q = d(b[l], l, v), null != q && (p[p.length] = q);
      else
        for (e in b) q = d(b[e], e, v), null != q && (p[p.length] = q);
      return p.concat.apply([], p)
    },
    guid: 1,
    proxy: function(b, d) {
      var v, q, e;
      return "string" == typeof d && (v = b[d], d = b, b = v), f.isFunction(b) ? (q = Y.call(arguments, 2), e = function() {
        return b.apply(d, q.concat(Y.call(arguments)))
      }, e.guid = b.guid = b.guid || f.guid++, e) : c
    },
    access: function(b, d, v, q, e, p, l) {
      var g, n = null ==
        v,
        j = 0,
        m = b.length;
      if (v && "object" == typeof v) {
        for (j in v) f.access(b, d, j, v[j], 1, p, q);
        e = 1
      } else if (q !== c) {
        g = l === c && f.isFunction(q);
        n && (g ? (g = d, d = function(b, c, A) {
          return g.call(f(b), A)
        }) : (d.call(b, q), d = null));
        if (d)
          for (; j < m; j++) d(b[j], v, g ? q.call(b[j], j, d(b[j], v)) : q, l);
        e = 1
      }
      return e ? b : n ? d.call(b) : m ? d(b[0], v) : p
    },
    now: function() {
  ...
  f.ready.promise = function(c) {
    if (!Ea)
      ...
      var d = !1;
      try {
        d = null == b.frameElement && C.documentElement
      } catch (v) {}
      d && d.doScroll && function ka() {
        if (!f.isReady) {
          try {
            d.doScroll("left")
          } catch (b) {
            return setTimeout(ka, 50)
          }
          f.ready()
        }
      }()
  ...
  f.Callbacks = function(b) {
    ...
    if ("string" ==
      ...
      if (!(d = Jb[b])) {
        d = b;
        var v = Jb[d] = {};
        d = (f.each(d.split(da), function(b, c) {
          v[c] = !0
        }), v)
      }
    } else d = f.extend({}, b);
    ...
    var q, e, p, l, g, n, j = [],
      ...
      u = function(c) {
        ...
        g = j.length;
        for (p = !0; j && n < g; n++)
          if (!1 === j[n].apply(c[0], c[1]) && b.stopOnFalse) {
            q = !1;
            break
          } p = !1;
        j && (m ? m.length && u(m.shift()) : q ? j = [] : y.disable())
      },
      y = {
        add: function() {
          if (j) {
            ...
            (function yc(c) {
              f.each(c, function(c, d) {
                var D = f.type(d);
                "function" === D && (!b.unique || !y.has(d)) ? j.push(d) : d && d.length && "string" !==
                  D && yc(d)
              })
            })(arguments);
            p ? g = j.length : q && (l = c, u(q))
          }
          return this
        },
        remove: function() {
          return j && f.each(arguments, function(b, c) {
            for (var A; - 1 < (A = f.inArray(c, j, A));) j.splice(A, 1), p && (A <= g && g--, A <= n && n--)
          }), this
        },
        has: function(b) {
        ...
        fireWith: function(b, c) {
          return c = c || [], c = [b, c.slice ? c.slice() : c], j && (!e || m) &&
            (p ? m.push(c) : u(c)), this
        },
        fire: function() {
  ...
  f.extend({
    Deferred: function(b) {
      var c = [
        ...
        q = {
          ...
          promise: function(b) {
            return null != b ? f.extend(b, q) : q
          }
        },
        e = {};
      return q.pipe = q.then, f.each(c, function(b, A) {
        var f = A[2],
          g = A[3];
        q[A[1]] = f.add;
        g && f.add(function() {
    ...
    when: function(b) {
      var c = 0,
        d = Y.call(arguments),
        q = d.length,
        e = 1 !== q || b && f.isFunction(b.promise) ? q : 0,
        p = 1 === e ? b : f.Deferred(),
        l = function(b, c, A) {
          return function(d) {
            c[b] = this;
            A[b] = 1 < arguments.length ? Y.call(arguments) : d;
            A === g ? p.notifyWith(c, A) : --e || p.resolveWith(c, A)
          }
        },
        g, n, j;
      if (1 < q) {
        g = Array(q);
        n = Array(q);
        for (j = Array(q); c < q; c++) d[c] && f.isFunction(d[c].promise) ? d[c].promise().done(l(c, j, d)).fail(p.reject).progress(l(c, n, g)) : --e
      }
      return e || p.resolveWith(j, d), p.promise()
    }
  });
  var Oc = f,
    db, N, Ha, ea, Ia, Ja, R, fa, Ka, eb,
    ta, Kb, J = C.createElement("div");
  ...
  if (!Ha || !Ha.length) db = {};
    ...
    Ia.disabled = !0;
    N.optDisabled = !Ja.disabled;
    try {
      delete J.test
    } catch (Qd) {
      N.deleteExpando = !1
    }!J.addEventListener && J.attachEvent && J.fireEvent && (J.attachEvent("onclick", Kb = function() {
      N.noCloneEvent = !1
    }), J.cloneNode(!0).fireEvent("onclick"), J.detachEvent("onclick", Kb));
    ...
    if (J.attachEvent)
      for (eb in {
          ...
          change: !0,
          focusin: !0
        }) Ka = "on" + eb, (ta = Ka in J) || (J.setAttribute(Ka, "return;"), ta = "function" == typeof J[Ka]), N[eb + "Bubbles"] = ta;
    db = (f(function() {
      var c, d, f, q, e = C.getElementsByTagName("body")[0];
      e && (c = C.createElement("div"), c.style.cssText =
        "visibility:hidden;border:0;width:0;height:0;position:static;top:0;margin-top:1px", e.insertBefore(c, e.firstChild), d = C.createElement("div"), c.appendChild(d), d.innerHTML = "<table><tr><td></td><td>t</td></tr></table>", f = d.getElementsByTagName("td"), f[0].style.cssText = "padding:0;margin:0;border:0;display:none", ta = 0 === f[0].offsetHeight, f[0].style.display = "", f[1].style.display = "none", N.reliableHiddenOffsets = ta && 0 === f[0].offsetHeight, d.innerHTML = "", d.style.cssText = "box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;padding:1px;border:1px;display:block;width:4px;margin-top:1%;position:absolute;top:1%;",
        N.boxSizing = 4 === d.offsetWidth, N.doesNotIncludeMarginInBodyOffset = 1 !== e.offsetTop, b.getComputedStyle && (N.pixelPosition = "1%" !== (b.getComputedStyle(d, null) || {}).top, N.boxSizingReliable = "4px" === (b.getComputedStyle(d, null) || {
          width: "4px"
        }).width, q = C.createElement("div"), q.style.cssText = d.style.cssText = "padding:0;margin:0;border:0;display:block;overflow:hidden;", q.style.marginRight = q.style.width = "0", d.style.width = "1px", d.appendChild(q), N.reliableMarginRight = !parseFloat((b.getComputedStyle(q, null) || {}).marginRight)),
    ...
    }), fa.removeChild(J), Ha = ea = Ia = Ja = R = fa = J = null, N)
  }
  Oc.support = db;
  var uc = /(?:\{[\s\S]*\}|\[[\s\S]*\])$/,
    tc = /([A-Z])/g;
    ...
    data: function(b, d, v, q) {
      if (f.acceptData(b)) {
        var e, p, l = f.expando,
          ...
          j = n ? f.cache : b,
          m = n ? b[l] : b[l] && l;
        if (m && j[m] && (q || j[m].data) || !(g && v === c)) {
          m || (n ? b[l] = m = f.deletedIds.pop() || f.guid++ : m = l);
          j[m] || (j[m] = {},
            n || (j[m].toJSON = f.noop));
          if ("object" == typeof d || "function" == typeof d) q ? j[m] = f.extend(j[m], d) : j[m].data = f.extend(j[m].data, d);
          return e = j[m], q || (e.data || (e.data = {}), e = e.data), v !== c && (e[f.camelCase(d)] = v), g ? (p = e[d], null == p && (p = e[f.camelCase(d)])) : p = e, p
        }
      }
    },
    removeData: function(b, c, d) {
      if (f.acceptData(b)) {
        var q, ka, p, l = b.nodeType,
          g = l ? f.cache : b,
          j = l ? b[f.expando] : f.expando;
        if (g[j]) {
          if (c && (q = d ? g[j] : g[j].data)) {
            f.isArray(c) || (c in q ? c = [c] : (c = f.camelCase(c), c in q ? c = [c] : c = c.split(" ")));
            ka = 0;
            for (p = c.length; ka <
              p; ka++) delete q[c[ka]];
            if (!(d ? e : f.isEmptyObject)(q)) return
          }
          if (d || !(delete g[j].data, !e(g[j]))) l ? f.cleanData([b], !0) : f.support.deleteExpando || g != g.window ? delete g[j] : g[j] = null
        }
      }
    },
    ...
    data: function(b, D) {
      ...
      if (b === c) {
        if (this.length && (m = f.data(j), 1 === j.nodeType && !f._data(j, "parsedAttrs"))) {
          g =
            j.attributes;
          for (l = g.length; n < l; n++) p = g[n].name, p.indexOf("data-") || (p = f.camelCase(p.substring(5)), d(j, p, m[p]));
      ...
      return "object" == typeof b ? this.each(function() {
        f.data(this, b)
      }) : (v = b.split(".", 2), v[1] = v[1] ? "." + v[1] : "", e = v[1] + "!", f.access(this, function(D) {
        if (D === c) return m = this.triggerHandler("getData" + e, [v[0]]), m === c && j && (m = f.data(j, b), m = d(j, b, m)), m === c && v[1] ? this.data(v[0]) : m;
        v[1] = D;
        this.each(function() {
          var c = f(this);
          ...
          f.data(this, b,
            D);
          c.triggerHandler("changeData" + e, v)
        })
  ...
  f.extend({
    ...
    dequeue: function(b, c) {
      ...
      g && ("fx" === c && d.unshift("inprogress"),
        delete p.stop, g.call(b, l, p));
      !e && p && p.empty.fire()
    },
  ...
  f.fn.extend({
    ...
    promise: function(b, d) {
      ...
      for (b = b || "fx"; l--;)(v = f._data(p[l], b + "queueHooks")) && v.empty && (e++, v.empty.add(j));
  ...
  f.fn.extend({
    ...
    toggleClass: function(b, c) {
      ...
      return f.isFunction(b) ? this.each(function(d) {
        ...
        if ("string" === d)
          for (var g, p = 0, l = f(this), j = c, n = b.split(da); g = n[p++];) j = e ? j : !l.hasClass(g), l[j ? "addClass" : "removeClass"](g);
    ...
    val: function(b) {
      ...
      if (g) return d = f.valHooks[g.type] || f.valHooks[g.nodeName.toLowerCase()], d && "get" in d && (v = d.get(g,
        "value")) !== c ? v : (v = g.value, "string" == typeof v ? v.replace(Pc, "") : null == v ? "" : v)
    }
  });
  f.extend({
    valHooks: {
      ...
      select: {
        get: function(b) {
          ...
          for (d = l ? e + 1 : p.length; b < d; b++)
            if (c = p[b], c.selected && (f.support.optDisabled ? !c.disabled : null === c.getAttribute("disabled")) && (!c.parentNode.disabled || !f.nodeName(c.parentNode, "optgroup"))) {
              c = f(c).val();
              if (l) return c;
              g.push(c)
            } return l && !g.length && p.length ? f(p[e]).val() : g
        },
        set: function(b, c) {
          var d = f.makeArray(c);
    ...
    attr: function(b, d, v, e) {
      ...
      if (b && !(3 === l || 8 === l || 2 === l)) {
        ...
        if (v !== c) {
          ...
          return p && "set" in p && e && (g = p.set(b, v, d)) !== c ? g : (b.setAttribute(d, v + ""), v)
        }
        return p && "get" in p && e && null !== (g = p.get(b, d)) ? g : (g = b.getAttribute(d), null === g ? c : g)
      }
    },
    removeAttr: function(b, c) {
      var d, e, g, p, l = 0;
      if (c && 1 === b.nodeType)
        for (e = c.split(da); l < e.length; l++)(g = e[l]) && (d = f.propFix[g] || g, p = Ob.test(g), p || f.attr(b, g, ""), b.removeAttribute(Pb ? g : d), p && d in b && (b[d] = !1))
    },
    attrHooks: {
      type: {
        set: function(b, c) {
    ...
    prop: function(b, d, v) {
      var e, g, p, l = b.nodeType;
      if (b && !(3 === l || 8 === l || 2 === l)) return p = 1 !== l || !f.isXMLDoc(b), p && (d = f.propFix[d] || d, g = f.propHooks[d]), v !== c ? g && "set" in g && (e = g.set(b, v, d)) !== c ? e : b[d] = v : g && "get" in g && null !== (e = g.get(b, d)) ? e : b[d]
    },
    propHooks: {
      tabIndex: {
        get: function(b) {
  ...
  f.event = {
    add: function(b, d, e, q, g) {
      var p, l, j, n, m, u, y, s, r;
      if (!(3 === b.nodeType || 8 === b.nodeType || !d || !e || !(p = f._data(b)))) {
        ...
        for (p = 0; p < d.length; p++) {
          ...
          u = (n[2] || "").split(".").sort();
          r = f.event.special[m] || {};
          m = (g ? r.delegateType : r.bindType) || m;
          r = f.event.special[m] || {};
          n = f.extend({
            type: m,
            origType: n[1],
          ...
          s = j[m];
          if (!s && (s = j[m] = [], s.delegateCount = 0, !r.setup || !1 === r.setup.call(b, q, u, l))) b.addEventListener ? b.addEventListener(m, l, !1) : b.attachEvent && b.attachEvent("on" + m, l);
          r.add && (r.add.call(b, n), n.handler.guid || (n.handler.guid = e.guid));
          g ? s.splice(s.delegateCount++, 0, n) : s.push(n);
          f.event.global[m] = !0
        }
        b = null
      }
    ...
    remove: function(b, c, d, e, g) {
      var p, l, j, n, m, u, y, s, r, z, x = f.hasData(b) && f._data(b);
      if (x && (y = x.events)) {
        c = f.trim(Sb(c || "")).split(" ");
        for (p = 0; p < c.length; p++)
          if (l = Qb.exec(c[p]) || [], j = n = l[1], l = l[2], j) {
            s = f.event.special[j] || {};
            j = (e ? s.delegateType : s.bindType) || j;
            r = y[j] || [];
            m = r.length;
            l = l ? RegExp("(^|\\.)" + l.split(".").sort().join("\\.(?:.*\\.|)") + "(\\.|$)") : null;
            for (u = 0; u < r.length; u++) z = r[u], (g || n === z.origType) && (!d || d.guid === z.guid) && (!l || l.test(z.namespace)) && (!e || e === z.selector || "**" === e && z.selector) && (r.splice(u--, 1), z.selector && r.delegateCount--, s.remove && s.remove.call(b, z));
            0 === r.length && m !== r.length && ((!s.teardown || !1 === s.teardown.call(b, l, x.handle)) && f.removeEvent(b,
              j, x.handle), delete y[j])
          } else
            for (j in y) f.event.remove(b, j + c[p], d, e, !0);
    ...
    trigger: function(d, D, e, q) {
      if (!e || 3 !== e.nodeType && 8 !== e.nodeType) {
        var g, p, l, j, n, m, u, y = d.type || d;
        j = [];
        if (!Rb.test(y + f.event.triggered) && (0 <= y.indexOf("!") && (y = y.slice(0, -1), g = !0), 0 <= y.indexOf(".") && (j = y.split("."), y = j.shift(), j.sort()), e && !f.event.customEvent[y] || f.event.global[y]))
          if (d = "object" == typeof d ? d[f.expando] ?
            d : new f.Event(y, d) : new f.Event(y), d.type = y, d.isTrigger = !0, d.exclusive = g, d.namespace = j.join("."), d.namespace_re = d.namespace ? RegExp("(^|\\.)" + j.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, j = 0 > y.indexOf(":") ? "on" + y : "", e) {
            if (d.result = c, d.target || (d.target = e), D = null != D ? f.makeArray(D) : [], D.unshift(d), n = f.event.special[y] || {}, !(n.trigger && !1 === n.trigger.apply(e, D))) {
              u = [
                [e, n.bindType || y]
              ];
              if (!q && !n.noBubble && !f.isWindow(e)) {
                p = n.delegateType || y;
                g = Rb.test(p + y) ? e : e.parentNode;
                for (l = e; g; g = g.parentNode) u.push([g, p]),
                  l = g;
                l === (e.ownerDocument || C) && u.push([l.defaultView || l.parentWindow || b, p])
              }
              for (p = 0; p < u.length && !d.isPropagationStopped(); p++) g = u[p][0], d.type = u[p][1], (m = (f._data(g, "events") || {})[d.type] && f._data(g, "handle")) && m.apply(g, D), (m = j && g[j]) && f.acceptData(g) && m.apply && !1 === m.apply(g, D) && d.preventDefault();
              return d.type = y, !q && !d.isDefaultPrevented() && (!n._default || !1 === n._default.apply(e.ownerDocument, D)) && ("click" !== y || !f.nodeName(e, "a")) && f.acceptData(e) && j && e[y] && ("focus" !== y && "blur" !== y || 0 !== d.target.offsetWidth) &&
                !f.isWindow(e) && (l = e[j], l && (e[j] = null), f.event.triggered = y, e[y](), f.event.triggered = c, l && (e[j] = l)), d.result
            }
          } else
            for (p in e = f.cache, e) e[p].events && e[p].events[y] && f.event.trigger(d, D, e[p].handle.elem, !0)
      }
    },
    dispatch: function(d) {
      d = f.event.fix(d || b.event);
      var e, v, q, g, p, l, j = (f._data(this, "events") || {})[d.type] || [],
        n = j.delegateCount,
        m = Y.call(arguments),
      ...
      if (!(y.preDispatch && !1 === y.preDispatch.call(this, d))) {
        if (n &&
          ...
          for (v = d.target; v != this; v = v.parentNode || this)
            if (!0 !== v.disabled || "click" !== d.type) {
              g = {};
              p = [];
              for (e = 0; e < n; e++) q = j[e], l = q.selector, g[l] === c && (g[l] = q.needsContext ? 0 <= f(l, this).index(v) : f.find(l, this, null, [v]).length), g[l] && p.push(q);
              p.length && s.push({
                elem: v,
                matches: p
              })
        ...
        for (e = 0; e < s.length && !d.isPropagationStopped(); e++) {
          ...
          for (v = 0; v < g.matches.length && !d.isImmediatePropagationStopped(); v++)
            if (q = g.matches[v],
              u || !d.namespace && !q.namespace || d.namespace_re && d.namespace_re.test(q.namespace)) d.data = q.data, d.handleObj = q, q = ((f.event.special[q.origType] || {}).handle || q.handler).apply(g.elem, m), q !== c && (d.result = q, !1 === q && (d.preventDefault(), d.stopPropagation()))
        }
    ...
    mouseHooks: {
      ...
      filter: function(b, d) {
        var f, e, g, p = d.button,
          l = d.fromElement;
        return null == b.pageX && null != d.clientX && (f = b.target.ownerDocument || C, e = f.documentElement, g = f.body, b.pageX = d.clientX + (e && e.scrollLeft || g && g.scrollLeft || 0) - (e && e.clientLeft ||
          g && g.clientLeft || 0), b.pageY = d.clientY + (e && e.scrollTop || g && g.scrollTop || 0) - (e && e.clientTop || g && g.clientTop || 0)), !b.relatedTarget && l && (b.relatedTarget = l === b.target ? d.toElement : l), !b.which && p !== c && (b.which = p & 1 ? 1 : p & 2 ? 3 : p & 4 ? 2 : 0), b
      }
    },
    fix: function(b) {
      ...
      var c, d, e = b,
        ...
        p = g.props ? this.props.concat(g.props) : this.props;
      b = f.Event(e);
  ...
  f.fn.extend({
    on: function(b, d, e, q, j) {
      ...
      }, q.guid = p.guid || (p.guid = f.guid++)), this.each(function() {
        f.event.add(this,
          b, q, e, d)
      })
    },
    ...
    off: function(b, d, e) {
      var q, j;
      if (b && b.preventDefault && b.handleObj) return q = b.handleObj, f(b.delegateTarget).off(q.namespace ? q.origType + "." + q.namespace : q.origType, q.selector, q.handler), this;
      if ("object" == typeof b) {
  ...
  var Wc = b,
    F = function(b, c, d, f) {
      ...
      if (!l && !f && (e = Xc.exec(b)))
        if (j = e[1])
          if (9 === n) {
            g = c.getElementById(j);
            if (!g || !g.parentNode) return d;
            if (g.id === j) return d.push(g), d
          } else {
            if (c.ownerDocument &&
              (g = c.ownerDocument.getElementById(j)) && Tb(c, g) && g.id === j) return d.push(g), d
          }
      else {
        if (e[2]) return na.apply(d, oa.call(c.getElementsByTagName(b), 0)), d;
        if ((j = e[3]) && Ub && c.getElementsByClassName) return na.apply(d, oa.call(c.getElementsByClassName(j), 0)), d
      }
    ...
    Pa = function(b, c) {
      var d, f, e, g, l, j, n;
      if (l = Wb[M][b]) return c ? 0 : l.slice(0);
      l = b;
      j = [];
      for (n = G.preFilter; l;) {
        if (!d || (f = Yc.exec(l))) f && (l = l.slice(f[0].length)), j.push(e = []);
        d = !1;
        if (f = Zc.exec(l)) e.push(d = new Xb(f.shift())), l = l.slice(d.length), d.type = f[0].replace(Ma, " ");
        for (g in G.filter)(f = Oa[g].exec(l)) &&
          (!n[g] || (f = n[g](f, V, !0))) && (e.push(d = new Xb(f.shift())), l = l.slice(d.length), d.type = g, d.matches = f);
        if (!d) break
      }
      return c ? l.length : l ? F.error(b) : Wb(b, j).slice(0)
    },
    ib = function(b, c, d) {
      var f = c.dir,
        e = d && "parentNode" === c.dir,
        g = $c++;
      return c.first ? function(c, d, D) {
        for (; c = c[f];)
          if (e || 1 === c.nodeType) return b(c, d, D)
      } : function(c, d, D) {
        if (D)
          for (; c = c[f];) {
            if ((e || 1 === c.nodeType) && b(c, d, D)) return c
          } else
            for (var v, j = va + " " + g + " ", n = j + hb; c = c[f];)
              if (e || 1 === c.nodeType) {
                if ((v = c[M]) === n) return c.sizset;
                if ("string" == typeof v &&
                  0 === v.indexOf(j)) {
                  if (c.sizset) return c
                } else {
                  c[M] = n;
                  if (b(c, d, D)) return c.sizset = !0, c;
                  c.sizset = !1
                }
              }
      }
    ...
    Qa = function(b, c, d, f, e) {
      for (var g, l = [], j = 0, n = b.length, m = null != c; j < n; j++)
        if (g = b[j])
          if (!d || d(g, f, e)) l.push(g), m && c.push(j);
      return l
    },
    kb = function(b, c, d, f, e, g) {
      return f && !f[M] && (f = kb(f)), e && !e[M] && (e = kb(e, g)), W(function(g, j, p, n) {
        if (!g || !e) {
          var m, u, y = [],
            s = [],
            r = j.length;
          if (!(u = g)) {
            ...
            var z =
              ...
              x = [];
            m = 0;
            for (var t = z.length; m < t; m++) F(u, z[m], x, g);
            u = x
          }
          z = b && (g || !c) ? Qa(u, y, b, p, n) : u;
          x = d ? e || (g ? b : r || f) ? [] : j : z;
          d && d(z, x, p, n);
          if (f) {
            u = Qa(x, s);
            f(u, [], p, n);
            for (p = u.length; p--;)
              if (m = u[p]) x[s[p]] = !(z[s[p]] = m)
          }
          if (g)
            for (p = b && x.length; p--;) {
              if (m = x[p]) g[y[p]] = !(j[y[p]] = m)
            } else x = Qa(x === j ? x.splice(r, x.length) : x), e ? e(null, j, x, n) : na.apply(j, x)
        }
      })
    },
    lb = function(b) {
      ...
      d = g || G.relative[" "];
      for (var l = g ? 1 : 0, j = ib(function(b) {
          return b === c
        }, d, !0), n = ib(function(b) {
          return -1 <
            Yb.call(c, b)
        }, d, !0), m = [function(b, d, f) {
          return !g && (f || d !== Ra) || ((c = d).nodeType ? j(b, d, f) : n(b, d, f))
        }]; l < e; l++)
        if (d = G.relative[b[l].type]) m = [ib(jb(m), d)];
        else {
          d = G.filter[b[l].type].apply(null, b[l].matches);
          if (d[M]) {
            for (f = ++l; f < e && !G.relative[b[f].type]; f++);
            return kb(1 < l && jb(m), 1 < l && b.slice(0, l - 1).join("").replace(Ma, "$1"), d, l < f && lb(b.slice(l, f)), f < e && lb(b = b.slice(f)), f < e && b.join(""))
          }
          m.push(d)
        } return jb(m)
    },
    gb = function(b, c, d, f, e) {
      ...
      if (!f && 1 === m.length) {
        l = m[0] = m[0].slice(0);
        if (2 < l.length &&
          "ID" === (j = l[0]).type && 9 === c.nodeType && !e && G.relative[l[1].type]) {
          c = G.find.ID(j.matches[0].replace(ia, ""), c, e)[0];
          if (!c) return d;
        ...
        for (g = Oa.POS.test(b) ? -1 : l.length - 1; 0 <= g; g--) {
          ...
          if (n = G.find[n])
            if (f = n(j.matches[0].replace(ia, ""), mb.test(l[0].type) && c.parentNode || c, e)) {
              l.splice(g, 1);
              b = f.length && l.join("");
      ...
      return nb(b, m)(f, c, e, d, mb.test(b)), d
    },
    Zb = function() {},
    ...
    hd = aa(function(b) {
      ...
      return ob = !V.getElementById(M), U.removeChild(b), c
    });
  try {
    oa.call(U.childNodes, 0)[0].nodeType
  } catch (Rd) {
    oa = function(b) {
  ...
  Tb = F.contains = U.contains ? function(b, c) {
    ...
    filter: {
      ...
      PSEUDO: function(b, c) {
        ...
        return f[M] ? f(c) : 1 < f.length ? (d = [b, b, "", c], G.setFilters.hasOwnProperty(b.toLowerCase()) ? W(function(b, d) {
          for (var e, A = f(b, c), g = A.length; g--;) e = Yb.call(b, A[g]), b[e] = !(d[e] = A[g])
        }) : function(b) {
          return f(b, 0, d)
        }) : f
      }
    ...
    pseudos: {
      not: W(function(b) {
        ...
        return f[M] ? W(function(b, c, d, e) {
          ...
          return c[0] = b, f(c, null, A, d), !d.pop()
        }
      }),
      has: W(function(b) {
        return function(c) {
  ...
  pb = U.compareDocumentPosition ? function(b, c) {
  ...
  nb = F.compile = function(b, c) {
    ...
    if (!g) {
      c || (c = Pa(b));
      for (d = c.length; d--;) g = lb(c[d]), g[M] ? f.push(g) : e.push(g);
      var l = 0 < f.length,
        j = 0 < e.length,
        n = function(b, c, d, A, g) {
          var D, v, p = [],
            m = 0,
            u = "0",
            y = b && [],
            s = null != g,
            r = Ra,
            x = b || j && G.find.TAG("*", g && c.parentNode || c),
            z = va += null == r ? 1 : Math.E;
          for (s && (Ra = c !== V && c, hb = n.el); null != (g = x[u]); u++) {
            if (j && g) {
              for (D = 0; v = e[D]; D++)
                if (v(g, c, d)) {
                  A.push(g);
            ...
            l && ((g = !v && g) && m--, b && y.push(g))
          }
          m += u;
          if (l && u !== m) {
            for (D = 0; v = f[D]; D++) v(y, p, c, d);
            if (b) {
              if (0 < m)
                for (; u--;) !y[u] && !p[u] && (p[u] = ad.call(A));
              p = Qa(p)
            }
            na.apply(A, p);
            s && !b && 0 < p.length && 1 < m + f.length && F.uniqueSort(A)
          }
          return s && (va = z, Ra = r), y
        };
      d = (n.el = 0, l ? W(n) : n);
      g = bc(b, d)
    }
  ...
  if (V.querySelectorAll) {
    var dc, id = gb,
      ...
      X = [":focus"],
      Ta = [":active", ":focus"],
      Ua = U.matchesSelector || U.mozMatchesSelector || U.webkitMatchesSelector || U.oMatchesSelector ||
      U.msMatchesSelector;
    aa(function(b) {
    ...
    gb = function(b, c, d, f, e) {
      if (!f && !e && (!X || !X.test(b))) {
        ...
        if (1 === c.nodeType && "object" !== c.nodeName.toLowerCase()) {
          g = Pa(b);
          (j = c.getAttribute("id")) ? n = j.replace(jd, "\\$&"): c.setAttribute("id", n);
          n = "[id='" + n + "'] ";
    ...
    Ua &&
      (aa(function(b) {
        ...
        c = c.replace(kd, "='$1']");
        if (!La(b) && !Ta.test(c) && (!X || !X.test(c))) try {
          var d = Ua.call(b, c);
  ...
  f.fn.extend({
    ...
    closest: function(b, c) {
      for (var d, e = 0, g = this.length,
          j = [], l = ec.test(b) || "string" != typeof b ? f(b, c || this.context) : 0; e < g; e++)
      ...
      return j = 1 < j.length ? f.unique(j) : j, this.pushStack(j, "closest", b)
    },
    index: function(b) {
  ...
  f.each({
    ...
    f.fn[b] = function(d, e) {
      ...
      return ld.test(b) ||
        (e = d), e && "string" == typeof e && (g = f.filter(e, g)), g = 1 < this.length && !nd[b] ? f.unique(g) : g, 1 < this.length && md.test(b) && (g = g.reverse()), this.pushStack(g, b, Y.call(arguments).join(","))
    }
  });
  f.extend({
  ...
  f.fn.extend({
    ...
    domManip: function(b, d, e) {
      ...
      var g, j, n, l = 0,
        ...
        u = [],
        y = this.length;
      if (!f.support.checkClone && 1 < y && "string" == typeof m && hc.test(m)) return this.each(function() {
        f(this).domManip(b, d, e)
      });
      if (f.isFunction(m)) return this.each(function(g) {
        var j = f(this);
        b[0] = m.call(this, g, d ? j.html() : c);
        j.domManip(b, d, e)
      });
      if (this[0]) {
        ...
        if (j) {
          d = d && f.nodeName(j, "tr");
          for (g = g.cacheable || y - 1; l < y; l++) e.call(d && f.nodeName(this[l], "table") ? this[l].getElementsByTagName("tbody")[0] || this[l].appendChild(this[l].ownerDocument.createElement("tbody")) : this[l], l === g ? n : f.clone(n, !0, !0))
        }
        n = j = null;
  ...
  f.buildFragment = function(b, d, e) {
    var g, j, n, l = b[0];
    return d = d || C, d = !d.nodeType && d[0] || d, d = d.ownerDocument || d, 1 === b.length && "string" == typeof l && 512 > l.length && d === C && "<" === l.charAt(0) && !sd.test(l) && (f.support.checkClone || !hc.test(l)) && (f.support.html5Clone || !tb.test(l)) && (j = !0, g = f.fragments[l], n = g !== c), g || (g = d.createDocumentFragment(), f.clean(b, d, g, e), j && (f.fragments[l] = n && g)), {
      fragment: g,
      cacheable: j
    }
  };
  ...
  f.each({
    ...
    f.fn[b] = function(d) {
      ...
      for (; g < l; g++) e = (0 < g ? this.clone(!0) : this).get(), f(d[g])[c](e), j = j.concat(e);
  ...
  f.extend({
    clone: function(b, c, d) {
      ...
      if ((!f.support.noCloneEvent || !f.support.noCloneChecked) && (1 === b.nodeType || 11 === b.nodeType) && !f.isXMLDoc(b)) {
        ...
        e = B(b);
        g = B(l);
        for (j = 0; e[j]; ++j) g[j] && z(e[j], g[j])
      }
      if (c && (r(b, l), d)) {
        e = B(b);
        g = B(l);
        for (j = 0; e[j]; ++j) r(e[j], g[j])
      }
      return l
    },
    clean: function(b, c, d, e) {
      var g, j, l, n, m, u, y, s = c === C && ic,
        r = [];
          ...
          if ("string" ==
            ...
            if (qd.test(l)) {
              ...
              if (!f.support.tbody) {
                ...
                for (j = n.length - 1; 0 <= j; --j) f.nodeName(n[j], "tbody") && !n[j].childNodes.length && n[j].parentNode.removeChild(n[j])
              }!f.support.leadingWhitespace && sb.test(l) && u.insertBefore(c.createTextNode(sb.exec(l)[0]),
                u.firstChild);
              l = u.childNodes;
    ...
    cleanData: function(b, c) {
      for (var d, e, g, j, l = 0, n = f.expando, m = f.cache, u = f.support.deleteExpando, y = f.event.special; null != (g = b[l]); l++)
        if (c || f.acceptData(g))
          if (d = (e = g[n]) && m[e]) {
            if (d.events)
              for (j in d.events) y[j] ? f.event.remove(g, j) : f.removeEvent(g, j, d.handle);
            m[e] && (delete m[e], u ? delete g[n] : g.removeAttribute ? g.removeAttribute(n) : g[n] = null, f.deletedIds.push(e))
          }
    }
  });
  var Va, ba;
  ...
  ba = {};
  Va.browser && (ba[Va.browser] = !0, ba.version = Va.version);
  ...
  f.extend({
    ...
    style: function(b, d, e, g) {
      if (b && !(3 === b.nodeType || 8 === b.nodeType || !b.style)) {
        var j, m, l, u = f.camelCase(d),
          y = b.style;
        d = f.cssProps[u] || (f.cssProps[u] = n(y, u));
        l = f.cssHooks[d] || f.cssHooks[u];
        if (e === c) return l && "get" in l && (j = l.get(b,
          !1, g)) !== c ? j : y[d];
        m = typeof e;
        "string" === m && (j = yd.exec(e)) && (e = (j[1] + 1) * j[2] + parseFloat(f.css(b, d)), m = "number");
        if (!(null == e || "number" === m && isNaN(e)))
          if ("number" === m && !f.cssNumber[u] && (e += "px"), !l || !("set" in l) || (e = l.set(b, e, g)) !== c) try {
            y[d] = e
          } catch (s) {}
      }
    },
    css: function(b, d, e, g) {
      var j, m, l, u = f.camelCase(d);
      return d = f.cssProps[u] || (f.cssProps[u] = n(b.style, u)), l = f.cssHooks[d] || f.cssHooks[u], l && "get" in l && (j = l.get(b, !0, g)), j === c && (j = O(b, d)), "normal" === j && d in kc && (j = kc[d]), e || g !== c ? (m = parseFloat(j), e ||
        f.isNumeric(m) ? m || 0 : j) : j
    },
    swap: function(b, c, d) {
      var e, f = {};
  ...
  b.getComputedStyle ? O = function(c, d) {
    var e, g, j, n, l = b.getComputedStyle(c, null),
      m = c.style;
    return l && (e = l[d], "" === e && !f.contains(c.ownerDocument, c) && (e = f.style(c, d)), ya.test(e) && jc.test(d) && (g = m.width, j = m.minWidth, n = m.maxWidth, m.minWidth = m.maxWidth = m.width = e, e = l.width, m.width = g, m.minWidth = j, m.maxWidth = n)), e
  } : C.documentElement.currentStyle && (O = function(b,
    c) {
    var d, e, f = b.currentStyle && b.currentStyle[c],
      g = b.style;
    return null == f && g && g[c] && (f = g[c]), ya.test(f) && !wd.test(c) && (d = g.left, e = b.runtimeStyle && b.runtimeStyle.left, e && (b.runtimeStyle.left = b.currentStyle.left), g.left = "fontSize" === c ? "1em" : f, f = g.pixelLeft + "px", g.left = d, e && (b.runtimeStyle.left = e)), "" === f ? "auto" : f
  });
  f.each(["height", "width"], function(b, c) {
    f.cssHooks[c] = {
      get: function(b, d, e) {
        if (d) return 0 === b.offsetWidth && xd.test(O(b, "display")) ? f.swap(b, zd, function() {
          return K(b, c, e)
        }) : K(b, c, e)
      },
      set: function(b,
  ...
  f.support.opacity || (f.cssHooks.opacity = {
    ...
    set: function(b, c) {
      ...
      d.zoom = 1;
      if (!(1 <= c && "" === f.trim(j.replace(vb, "")) && d.removeAttribute && (d.removeAttribute("filter"), e && !e.filter))) d.filter =
        vb.test(j) ? j.replace(vb, g) : j + " " + g
    }
  });
  f(function() {
    ...
    f.cssHooks[b + c] = {
      expand: function(d) {
        var e = "string" == typeof d ? d.split(" ") : [d],
          f = {};
        for (d = 0; 4 > d; d++) f[b + ca[d] + c] = e[d] || e[d - 2] || e[0];
        return f
      }
    };
  ...
  try {
    ...
    ja = C.createElement("a"), ja.href = "", ja = ja.href
  }
  pa = nc.exec(ja.toLowerCase()) || [];
  f.fn.load = function(b, d, e) {
    if ("string" != typeof b && oc) return oc.apply(this, arguments);
    if (!this.length) return this;
    var g, j, n, l = this,
      m = b.indexOf(" ");
    return 0 <= m && (g = b.slice(m, b.length), b = b.slice(0, m)), f.isFunction(d) ? (e = d, d = c) : d && "object" == typeof d && (j = "POST"), f.ajax({
      url: b,
      type: j,
      dataType: "html",
      data: d,
  ...
  f.each(["get", "post"], function(b, d) {
    f[d] = function(b, e, g, j) {
      return f.isFunction(e) && (j = j || g, g = e, e = c), f.ajax({
        type: d,
        url: b,
        data: e,
        success: g,
  ...
  f.extend({
    ...
    ajax: function(b, d) {
      function e(b, d, n, u) {
        ...
        if (2 !== P) {
          ...
          if (n) {
            v = r;
            u = H;
            var C, K, I, Za, ab = v.contents,
              F = v.dataTypes,
              J = v.responseFields;
            for (K in J) K in n && (u[J[K]] = n[K]);
            for (;
              "*" === F[0];) F.shift(),
              C === c && (C = v.mimeType || u.getResponseHeader("content-type"));
            if (C)
              for (K in ab)
                if (ab[K] && ab[K].test(C)) {
                  F.unshift(K);
            ...
            v = n = I ? (I !== F[0] && F.unshift(I), n[I]) : void 0
          }
          if (200 <= b && 300 > b || 304 === b)
            if (r.ifModified && (D = H.getResponseHeader("Last-Modified"), D && (f.lastModified[g] = D), D = H.getResponseHeader("Etag"), D && (f.etag[g] = D)), 304 === b) E = "notmodified", A = !0;
            else {
              var G;
              a: {
                A = r;p = v;
                var T, E = A.dataTypes.slice();n =
                E[0];C = {};K = 0;A.dataFilter && (p = A.dataFilter(p, A.dataType));
                if (E[1])
                  for (G in A.converters) C[G.toLowerCase()] = A.converters[G];
                for (; s = E[++K];)
                  if ("*" !== s) {
                    if ("*" !== n && n !== s) {
                      G = C[n + " " + s] || C["* " + s];
                      if (!G)
                        for (T in C)
                          if (D = T.split(" "), D[1] === s && (G = C[n + " " + D[0]] || C["* " + D[0]])) {
                            !0 === G ? G = C[T] : !0 !== C[T] && (s = D[0], E.splice(K--, 0, s));
                            break
                          } if (!0 !== G)
                        if (G && A["throws"]) p = G(p);
                        else try {
                          ...
                          G = {
                            state: "parsererror",
                            error: G ? xa : "No conversion from " + n + " to " + s
                          };
                          break a
                        }
                    }
          ...
          H.status = b;
          H.statusText = (d || E) + "";
          A ? t.resolveWith(x, [p, E, H]) : t.rejectWith(x, [H, E, s]);
          H.statusCode(B);
          B = c;
          y && z.trigger("ajax" + (A ? "Success" : "Error"), [H, r, A ? p : s]);
          L.fireWith(x, [H, E]);
      ...
      d = d || {};
      var g, j, n, l, m, u, y, s, r = f.ajaxSetup({}, d),
        x = r.context || r,
        ...
        H = {
          ...
          getResponseHeader: function(b) {
            ...
            if (2 === P) {
              if (!n)
                for (n = {}; d = Fd.exec(j);) n[d[1].toLowerCase()] = d[2];
              d = n[b.toLowerCase()]
            }
            return d === c ? null : d
          },
      ...
      r.url = ((b || r.url) + "").replace(Ed, "").replace(Hd, pa[1] + "//");
      r.dataTypes = f.trim(r.dataType || "*").toLowerCase().split(da);
      null == r.crossDomain && (u = nc.exec(r.url.toLowerCase()) || !1, r.crossDomain = u && u.join(":") + (u[3] ? "" : "http:" === u[1] ? 80 : 443) !== pa.join(":") + (pa[3] ? "" : "http:" === pa[1] ? 80 : 443));
      ...
      if (!r.hasContent && (r.data && (r.url += (mc.test(r.url) ? "&" : "?") + r.data, delete r.data), g = r.url, !1 === r.cache)) {
        u = f.now();
        var I = r.url.replace(Jd, "$1_=" + u);
        r.url = I + (I === r.url ? (mc.test(r.url) ? "&" : "?") + "_=" + u : "")
      ...
      H.setRequestHeader("Accept", r.dataTypes[0] && r.accepts[r.dataTypes[0]] ? r.accepts[r.dataTypes[0]] + ("*" !== r.dataTypes[0] ? ", " + qc + "; q=0.01" : "") : r.accepts["*"]);
  ...
  f.ajaxPrefilter("json jsonp", function(d, e, g) {
    var j, n, m, l = d.data,
      ...
      r = y && Wa.test(u),
      s = y &&
      !r && "string" == typeof l && !(d.contentType || "").indexOf("application/x-www-form-urlencoded") && Wa.test(l);
    if ("jsonp" === d.dataTypes[0] || r || s) return j = d.jsonpCallback = f.isFunction(d.jsonpCallback) ? d.jsonpCallback() : d.jsonpCallback, n = b[j], r ? d.url = u.replace(Wa, "$1" + j) : s ? d.data = l.replace(Wa, "$1" + j) : y && (d.url += (Kd.test(u) ? "&" : "?") + d.jsonp + "=" + j), d.converters["script json"] = function() {
      return m || f.error(j + " was not called"), m[0]
    }, d.dataTypes[0] = "json", b[j] = function() {
      m = arguments
    }, g.always(function() {
      b[j] = n;
      d[j] &&
        (d.jsonpCallback = e.jsonpCallback, rc.push(j));
      m && f.isFunction(n) && n(m[0]);
      m = n = c
    }), "script"
  });
  f.ajaxSetup({
    ...
    if (!d.crossDomain || f.support.cors) {
      ...
      return {
        send: function(g, j) {
          ...
          try {
            for (m in g) l.setRequestHeader(m, g[m])
          } catch (u) {}
          ...
          e = function(b, g) {
            ...
            try {
              if (e && (g || 4 === l.readyState))
                if (e = c, n && (l.onreadystatechange = f.noop, wb && delete qa[n]), g) 4 !== l.readyState && l.abort();
                else {
                  m = l.status;
                  p = l.getAllResponseHeaders();
                  y = {};
                  (r = l.responseXML) && r.documentElement && (y.xml = r);
                  try {
                    y.text =
                      l.responseText
                  } catch (s) {}
          ...
          d.async ? 4 === l.readyState ? setTimeout(e, 0) : (n = ++Md, wb && (qa || (qa = {}, f(b).unload(wb)), qa[n] = e), l.onreadystatechange = e) : e()
        },
        abort: function() {
          e && e(0, 1)
        }
  ...
  var Ba, Xa, Nd = /^(?:toggle|show|hide)$/,
    ...
    Pd = /queueHooks$/,
    Ca = [function(b, c, d) {
      var e, g, j, n, m, y, r = this,
        s = b.style,
        x = {},
        z = [],
        t = b.nodeType && u(b);
      d.queue ||
        (m = f._queueHooks(b, "fx"), null == m.unqueued && (m.unqueued = 0, y = m.empty.fire, m.empty.fire = function() {
          m.unqueued || y()
        }), m.unqueued++, r.always(function() {
          r.always(function() {
            m.unqueued--;
            f.queue(b, "fx").length || m.empty.fire()
          })
        }));
      1 === b.nodeType && ("height" in c || "width" in c) && (d.overflow = [s.overflow, s.overflowX, s.overflowY], "inline" === f.css(b, "display") && "none" === f.css(b, "float") && (!f.support.inlineBlockNeedsLayout || "inline" === xa(b.nodeName) ? s.display = "inline-block" : s.zoom = 1));
      ...
      for (e in c) g = c[e], Nd.exec(g) && (delete c[e], g !== (t ? "hide" : "show") && z.push(e));
      if (g = z.length) {
        j = f._data(b, "fxshow") || f._data(b, "fxshow", {});
        ...
        for (e = 0; e < g; e++) c = z[e], n = r.createTween(c, t ? j[c] : 0), x[c] = j[c] || f.style(b, c), c in j || (j[c] = n.start, t && (n.end = n.start,
    ...
    sa = {
      "*": [function(b, c) {
        ...
        if (j) {
          d = +j[2];
          e = j[3] || (f.cssNumber[b] ? "" : "px");
          if ("px" !== e && m) {
            m = f.css(g.elem, b, !0) || d || 1;
            do u = u || ".5", m /= u, f.style(g.elem, b, m + e); while (u !== (u = g.cur() / n) && 1 !== u && --y)
          }
          g.unit = e;
          g.start = m;
          g.end = j[1] ? m + (j[1] + 1) * d : d
        }
        return g
      }]
    };
  ...
  f.each(["toggle", "show", "hide"], function(b, c) {
    var d = f.fn[c];
    f.fn[c] = function(e, g, j) {
      return null == e || "boolean" == typeof e || !b && f.isFunction(e) && f.isFunction(g) ? d.apply(this, arguments) : this.animate(Da(c, !0), e, g, j)
    }
  });
  f.fn.extend({
    ...
    stop: function(b, d, e) {
      ...
      return "string" != typeof b && (e = d, d = b, b = c), d && !1 !== b && this.queue(b || "fx", []), this.each(function() {
        var c = !0,
          ...
          j = f.timers,
          n = f._data(this);
        if (d) n[d] && n[d].stop && g(n[d]);
        else
          for (d in n) n[d] &&
            n[d].stop && Pd.test(d) && g(n[d]);
  ...
  f.fn.offset = function(b) {
    ...
    var d, e, g, j, n, l, m, u = {
      ...
      y = this[0],
      r = y && y.ownerDocument;
    if (r) return (e = r.body) === y ? f.offset.bodyOffset(y) : (d = r.documentElement, f.contains(d, y) ? ("undefined" != typeof y.getBoundingClientRect && (u = y.getBoundingClientRect()), g = Db(r), j = d.clientTop || e.clientTop || 0, n = d.clientLeft || e.clientLeft || 0, l = g.pageYOffset || d.scrollTop, m = g.pageXOffset || d.scrollLeft, {
      top: u.top + l - j,
      left: u.left + m - n
    }) : u)
  };
  f.offset = {
    ...
    setOffset: function(b, c, d) {
      ...
      var g = f(b),
        ...
        y = {},
        r, s;
      ("absolute" === e || "fixed" === e) && -1 < f.inArray("auto", [n, m]) ? (y = g.position(), r = y.top, s = y.left) : (r = parseFloat(n) || 0, s = parseFloat(m) || 0);
      f.isFunction(c) && (c = c.call(b, d, j));
      null !=
        c.top && (u.top = c.top - j.top + r);
      null != c.left && (u.left = c.left - j.left + s);
  ...
  f.each({
    ...
    var e = /Y/.test(d);
    f.fn[b] = function(g) {
      return f.access(this, function(b, g, j) {
        var n = Db(b);
        if (j === c) return n ? d in n ? n[d] : n.document.documentElement[g] : b[g];
        n ? n.scrollTo(e ? f(n).scrollLeft() : j, e ? j : f(n).scrollTop()) : b[g] = j
    ...
    f.each({
      ...
      f.fn[g] = function(g, j) {
        var n = arguments.length && (e || "boolean" != typeof g),
          m = e || (!0 === g || !0 === j ? "margin" : "border");
        return f.access(this, function(d, e, g) {
          var j;
          return f.isWindow(d) ? d.document.documentElement["client" + b] : 9 === d.nodeType ? (j = d.documentElement, Math.max(d.body["scroll" + b], j["scroll" + b], d.body["offset" + b], j["offset" + b], j["client" + b])) : g === c ? f.css(d, e, g, m) : f.style(d, e, g, m)
        }, d, n ? g : c, n, null)
      }
    })
  });
    ...
    if (b && b.canPlayType && !1 === this.settings.useFlash) {
      for (var c = [{
        ...
        if (e = c[g].e, c[g].m.length && "object" === typeof c[g].m)
          for (var t = 0, m = c[g].m.length; t < m; t++)
  ...
  z.prototype = {
    ...
    play: function(d, e) {
      ...
      g._inactiveNode(function(j) {
        j._sprite =
          d;
        var m = 0 < j._pos ? j._pos : g._sprite[d][0] / 1E3,
          s = 0;
        g._webAudio ? (s = g._sprite[d][1] / 1E3 - j._pos, 0 < j._pos && (m = g._sprite[d][0] / 1E3 + m)) : s = g._sprite[d][1] / 1E3 - (m - g._sprite[d][0] / 1E3);
        ...
        if (g._webAudio) {
          ...
          B.bufferSource.loop = t[0];
          t[0] && (B.bufferSource.loopStart = t[1], B.bufferSource.loopEnd = t[1] + t[2]);
          B.bufferSource.playbackRate.value = g._rate;
          g._playStart = c.currentTime;
          j.gain.value = g._volume;
          "undefined" === typeof j.bufferSource.start ? z ? j.bufferSource.noteGrainOn(0, m, 86400) : j.bufferSource.noteGrainOn(0,
            m, s) : z ? j.bufferSource.start(0, m, 86400) : j.bufferSource.start(0, m, s)
        } else if (4 === j.readyState || !j.readyState && navigator.isCocoonJS) j.readyState = 4, j.id = x, j.currentTime = m, j.muted = r._muted || j.muted, j.volume = g._volume * r.volume(), setTimeout(function() {
          j.play()
        }, 0);
        else {
          g._clearEndTimer(x);
...
(function(b) {
  ...
  b.ig = {
    ...
    getImagePixels: function(b, c, d, e, g) {
      ...
      return 1 === n ? t.getImageData(c, d, e, g) : t.getImageDataHD(c, d, e, g)
    },
    module: function(b) {
...
ig.module("impact.image").defines(function() {
  ig.Image = ig.Class.extend({
    ...
    resize: function(b) {
      ...
      g.width = d;
      g.height = e;
      for (var j = g.getContext("2d"), t = j.getImageData(0, 0, d, e), m = 0; m < e; m++)
        for (var s = 0; s < d; s++) {
          var x = 4 * (Math.floor(m / b) * this.width + Math.floor(s / b)),
            r = 4 * (m * d + s);
          t.data[r] = c.data[x];
    ...
    drawTile: function(b, c, d, e, g, j, t) {
      ...
      if (this.loaded && !(e > this.width || g > this.height)) {
        ...
        ig.system.context.drawImage(this.data, Math.floor(d * e) % this.width * m, Math.floor(d * e / this.width) * g * m, s, x, ig.system.getDrawPos(b) * r - (j ? s : 0), ig.system.getDrawPos(c) * z - (t ? x : 0), s, x);
        (j ||
...
ig.module("impact.collision-map").requires("impact.map").defines(function() {
  ig.CollisionMap = ig.Map.extend({
    ...
    trace: function(b, c, g, j, t, m) {
      ...
      if (1 < x)
        for (var r = g / x, z = j / x, B = 0; B < x && (r || z) && !(this._traceStep(s,
            b, c, r, z, t, m, g, j, B), b = s.pos.x, c = s.pos.y, s.collision.x && (g = r = 0), s.collision.y && (j = z = 0), s.collision.slope); B++);
      else this._traceStep(s, b, c, g, j, t, m, g, j, 0);
      return s
    },
    _traceStep: function(b, c, g, j, t, m, s, x, r, z) {
      b.pos.x += j;
      b.pos.y += t;
      var B = 0;
      if (j) {
        ...
        if (0 <= j && j < this.width)
          for (var L =
              B; L < u && !(-1 != y && (B = this.data[L][y], 1 < B && B <= this.lastSlope && this._checkTileDef(b, B, c, g, x, r, m, s, y, L))); L++)
            if (B = this.data[L][j], 1 == B || B > this.lastSlope || 1 < B && this._checkTileDef(b, B, c, g, x, r, m, s, j, L)) {
      ...
      if (t) {
        ...
        if (0 <= L && L < this.height)
          for (j = B; j < n && !(-1 != u && (B = this.data[u][j], 1 < B && B <= this.lastSlope && this._checkTileDef(b, B, c, g, x, r, m, s, j, u))); j++)
            if (B = this.data[L][j], 1 == B || B > this.lastSlope || 1 < B && this._checkTileDef(b, B, c, g, x, r, m, s, j, L)) {
              if (1 < B && B <= this.lastSlope && b.collision.slope) break;
              b.collision.y = !0;
              b.tile.y = B;
    ...
    _checkTileDef: function(b, c, g, j, t, m, s, x, r, z) {
      ...
      var E = (B[3] - B[1]) * this.tilesize,
        n = B[4];
      s = g + t + (0 > E ? s : 0) - (r + B[0]) * this.tilesize;
      x = j + m + (0 < c ? x : 0) - (z + B[1]) * this.tilesize;
      if (0 < c * x - E * s) {
        ...
        var u = s * z + x * r,
          B = z * u,
          u = r * u;
        if (B * B + u * u >= t * t + m * m) return n || 0.5 > c * (x - m) - E * (s - t);
        b.pos.x = g + t - B;
        b.pos.y = j + m - u;
        b.collision.slope = {
          x: c,
...
ig.module("impact.background-map").requires("impact.map", "impact.image").defines(function() {
  ig.BackgroundMap = ig.Map.extend({
      ...
      for (e = 0; e < g; e++)
        for (var x = 0; x < j; x++)
          if (e + b < this.width && x + c < this.height) {
            ...
            r && this.tiles.drawTile(e * this.tilesize - t, x * this.tilesize - m, r - 1, this.tilesize)
          } ig.system.context = d;
      return s
    },
    draw: function() {
    ...
    drawPreRendered: function() {
      ...
      this.repeat || (g = Math.min(g, t), j = Math.min(j, m));
      for (var s = 0; e < j; e++) {
        for (var x = 0, r = d; r < g; r++) {
          var z = this.preRenderedChunks[e % m][r % t],
            B = -b + r * this.chunkSize - x,
            E = -c + e * this.chunkSize - s;
          ig.system.context.drawImage(z, B, E);
          ig.Image.drawCount++;
          this.debugChunks && (ig.system.context.strokeStyle = "#f0f", ig.system.context.strokeRect(B, E, this.chunkSize, this.chunkSize));
          this.repeat && z.width < this.chunkSize && B + z.width < ig.system.realWidth && (x += this.chunkSize - z.width, g++)
        }
    ...
    drawTiled: function() {
      for (var b = 0, c = null, d = (this.scroll.x / this.tilesize).toInt(),
          e = (this.scroll.y / this.tilesize).toInt(), g = this.scroll.x % this.tilesize, j = this.scroll.y % this.tilesize, t = -g - this.tilesize, g = ig.system.width + this.tilesize - g, m = ig.system.height + this.tilesize - j, s = -1, j = -j - this.tilesize; j < m; s++, j += this.tilesize) {
        var x = s + e;
    ...
    checkEntities: function() {
      for (var b = {}, c = 0; c < this.entities.length; c++) {
        ...
        if (!(d.type == ig.Entity.TYPE.NONE && d.checkAgainst == ig.Entity.TYPE.NONE && d.collides == ig.Entity.COLLIDES.NEVER))
          for (var e = {}, g = Math.floor(d.pos.y / this.cellSize), j = Math.floor((d.pos.x + d.size.x) / this.cellSize) + 1, t = Math.floor((d.pos.y + d.size.y) / this.cellSize) + 1, m = Math.floor(d.pos.x / this.cellSize); m < j; m++)
            for (var s = g; s < t; s++)
              if (b[m])
                if (b[m][s]) {
                  for (var x = b[m][s], r = 0; r < x.length; r++) d.touches(x[r]) && !e[x[r].id] && (e[x[r].id] = !0, ig.Entity.checkPair(d, x[r]));
                  x.push(d)
                } else b[m][s] = [d];
        else b[m] = {}, b[m][s] = [d]
      }
    ...
    windowKeyDown: function(b) {
      ...
      if (window.navigator.msPointerEnabled) {
        ...
        for (var g = 0; g < b.length; ++g) {
          for (var j = b[g], t = "undefined" != typeof j.identifier ? j.identifier : "undefined" != typeof j.pointerId ? j.pointerId : 1, m = (j.clientX - e.left) / c, j = (j.clientY - e.top) / d, s = 0; s < this.touches.length; ++s) this.touches[s].identifier == t && this.touches.splice(s, 1);
          this.touches.push({
            x: m,
            y: j,
            identifier: t
...
ig.baked = !0;
ig.module("plugins.wild-tangent").defines(function() {
  ig.WildTangentAPI = ig.Class.extend({
    API_ID: "WildTangentVideoAPI",
    Ad: {
      "default": {
        source: "https://wtars-a.akamaihd.net/libs/wtv.min.js?partner=testpartner&product=testgame&genre=testgenre&elementId=wt_ad",
        width: 660,
        height: 520
      },
      small: {
        source: "https://wtars-a.akamaihd.net/libs/wtv.min.js?partner=testpartner&product=testgame&genre=testgenre&elementId=wt_ad&size=small",
        width: 320,
        height: 290
      }
    },
    ...
    init: function() {
      !0 ===
        this.debugging && console.log("wildTangentAPI plugin initialized ...");
      this.setupEvent();
      return this
    },
    requestAd: function() {
      window.parent.postMessage("event=pause_ready", "*")
    },
    onAdShow: function() {
      ig && ig.game && ig.game.pauseGame();
      ig && ig.soundHandler && !1 === ig.soundHandler.muted && (ig.soundHandler.setForceMuted(!0), ig.soundHandler.mute());
      ig.servingAd = !0
    },
    onAdHide: function() {
      ig.servingAd = !1;
      ig && ig.game && ig.game.resumeGame();
      ig && ig.soundHandler && !0 === ig.soundHandler.muted && (ig.soundHandler.setForceMuted(!1),
        ig.soundHandler.unmute(), ig && ig.game && ig.game.updateAudio())
    },
    closeAd: function() {
      var b = ig.wildTangentAPI;
      !0 === b.debugging && console.log("Video completed and callback made.");
    ...
    showAd: function() {
      var b = ig.wildTangentAPI;
      b.onAdShow();
      MobileAdInGamePreroll.Close = function() {
        MobileAdInGamePreroll.boxContents.close.hide();
        MobileAdInGamePreroll.overlay.hide();
        b.initAd()
      };
      !0 === b.debugging && console.log("show ad");
      MobileAdInGamePreroll.Initialize();
      WildTangentVideo.showAd(b.closeAd)
    },
    messageHandler: function(b) {
      "action=pause" == b.data && (console.log("action=pause"), this.onAdShow());
      "action=resume" == b.data && (console.log("action=resume"), this.onAdHide())
    },
    setupEvent: function() {
      window.addEventListener ? addEventListener("message", this.messageHandler.bind(this), !1) : window.attachEvent && attachEvent("onmessage", this.messageHandler.bind(this))
    },
    checkAdChange: function() {
      var b = !1;
      this._PREV_AD = this.currentAd;
      this.setupAd();
      this.currentAd !== this._PREV_AD && (b = !0, this.resetAPI());
      this._PREV_AD =
        this.currentAd;
      return b
    },
    setupAd: function() {
      this.currentAd = this.Ad.default;
      if (window.innerWidth && window.innerHeight && (window.innerWidth < this.currentAd.width || window.innerHeight < this.currentAd.height)) this.currentAd = this.Ad.small
    },
    resetAPI: function() {
      this.API_SCRIPT_PARENT && this.API_SCRIPT && (this.API_SCRIPT_PARENT.removeChild(this.API_SCRIPT), this.API_SCRIPT = null);
      this.setupAPI()
    },
    setupAPI: function() {
      ...
      b.appendChild(c);
      c.setAttribute("id", this.API_ID);
      c.setAttribute("src", this.currentAd.source);
      c.onload = function() {
        !0 === ig.wildTangentAPI.debugging && console.log("Loaded WildTangengt API");
        ig.wildTangentAPI.adReady()
      };
      _SETTINGS.Ad.Mobile.Preroll.Duration = this.currentAd.adInterval;
      _SETTINGS.Ad.Mobile.Preroll.Width = this.currentAd.width;
      _SETTINGS.Ad.Mobile.Preroll.Height = this.currentAd.height;
      advancedDivsToResize.MobileAdInGamePreroll["box-width"] = _SETTINGS.Ad.Mobile.Preroll.Width + 2;
      advancedDivsToResize.MobileAdInGamePreroll["box-height"] =
        _SETTINGS.Ad.Mobile.Preroll.Height + 20;
      MobileAdInGamePreroll.ad_duration = this.currentAd.adInterval;
      MobileAdInGamePreroll.ad_width = this.currentAd.width;
      MobileAdInGamePreroll.ad_height = this.currentAd.height;
      MobileAdInGamePreroll.Timer = function() {};
      this.API_SCRIPT = c;
      this.API_SCRIPT_PARENT = b
    },
    adReady: function() {
      adInterval && this.setTimer(adInterval);
      this.initAd()
    },
    initAd: function() {
      var b = ig.wildTangentAPI;
  ...
  ig.wildTangentAPI = new ig.WildTangentAPI
});
...
ig.module("plugins.branding.splash").requires("impact.impact", "impact.entity").defines(function() {
  ...
  EntityBranding = ig.Entity.extend({
    ...
    createClickableOutboundLayer: function(b, c, d, e) {
      ...
      if (ig.ua.mobile) {
        var j = window.innerHeight / mobileHeight,
          t = window.innerWidth / mobileWidth;
    ...
    draw: function() {
      ...
      this.parent();
      this.splash && ig.system.context.drawImage(this.splash.data, 0, 0, this.splash.data.width, this.splash.data.height,
...
ig.module("game.entities.control-logic").requires("impact.entity").defines(function() {
  EntityControlLogic = ig.Entity.extend({
    ...
    update: function() {
      ...
      if ("play" != ig.game.gameState || !this.logicUpdate) this.manaTimer.reset();
        ...
        if (0 < d.length)
          ...
          c.x, c.y), this.mana -= this.checkManaConsumption(b), this.cardThrow = [], this.cardThrow.push(b), this.replaceCardInHand())));
        if (this.towerDangerous) {
    ...
    troopsClosedTowerEnemy: function(b, c) {
      for (var d = 0, e = 0, g = 0, j = ig.game.getEntitiesByType(EntityTower), t = [], m = {
          x: 0,
          y: 0
        }, s = 0; s < j.length; s++) {
        var x = j[s];
        ...
        for (x = 0; x < t.length; x++) {
          ...
          if ("red" == s.flag && s.distanceTo(r) < this.disArea)
            if (225 > s.pos.x && 425 > s.pos.y) {
              if (d += 1, d >= c) return m.x = 148, m.y = 360, m
            } else if (240 < s.pos.x && 425 > s.pos.y) {
            if (e += 1, e >= c) return m.x = 332, m.y = 360, m
          } else if (425 <= s.pos.y && (g += 1, g >= c)) return m.x = 230, m.y = 400, m
        }
      }
      return m
    },
...
ig.module("game.entities.ui.ending-result").requires("impact.entity", "game.entities.buttons.button-oke").defines(function() {
  EntityEndingResult = ig.Entity.extend({
    ...
    update: function() {
      ...
      if (this.rsTropi.end && this.bsTropi.end && !this.showOke) {
        this.showOke = !0;
        this.okBtn.moveBtn();
        this.score.intScoreRed >
          this.score.intScoreBlue ? (this.poswin.x = 105, this.poswin.y = 70, this.winnerIs = "Red") : this.score.intScoreRed < this.score.intScoreBlue ? (this.poswin.x = 105, this.poswin.y = 260, this.winnerIs = "Blue") : (this.poswin.x = -600, this.winnerIs = "Draw");
        try {
          ig.wildTangentAPI.requestAd()
        } catch (b) {
          console.log(b)
        }
      }
    ...
    showResult: function() {
      ...
      this.randomName = "";
      this.randomName =
        1 == b ? _STRINGS.AIName.One : 2 == b ? _STRINGS.AIName.Two : 3 == b ? _STRINGS.AIName.Three : 4 == b ? _STRINGS.AIName.Four : 5 == b ? _STRINGS.AIName.Five : 6 == b ? _STRINGS.AIName.Six : 7 == b ? _STRINGS.AIName.Seven : 8 == b ? _STRINGS.AIName.Eight : 9 == b ? _STRINGS.AIName.Nine : _STRINGS.AIName.Ten;
      this.timer.set(1);
      this.gameEnd = !0
    },
    ...
    drawWinner: function() {
      ...
      ig.system.context.drawImage(this.allImage.data, b.x, b.y, b.w, b.h, this.pos.x + this.poswin.x, this.pos.y +
        this.poswin.y, b.w, b.h)
    },
    ...
    drawBlueWinning: function() {
      ...
      b.drawImage(this.allImage.data,
        c.x, c.y, c.w, c.h, this.pos.x + this.posBlue.x, this.pos.y + this.posBlue.y, c.w, c.h);
      b.save();
      b.font = "20pt troika";
      b.textAlign = "center";
      b.fillStyle = "#FFF";
    ...
    drawRedRTropi: function() {
      ...
      b.drawImage(this.allImage.data, c.x, c.y, c.w,
        c.h, 0, 0, c.w, c.h);
      b.restore()
    },
    ...
    drawBlueRTropi: function() {
      ...
      b.translate(ig.system.getDrawPos(349 - 0.5 * c.w * this.bsTropi.rightScale -
        ig.game.screen.x), ig.system.getDrawPos(d - ig.game.screen.y));
...
ig.baked = !0;
ig.module("game.main").requires("impact.game", "plugins.patches.webkit-image-smoothing-patch", "plugins.patches.windowfocus-onMouseDown-patch", "plugins.handlers.dom-handler", "plugins.handlers.size-handler", "plugins.handlers.api-handler", "plugins.audio.sound-handler", "plugins.io.io-manager", "plugins.splash-loader", "plugins.tween", "plugins.url-parameters", "plugins.director", "plugins.impact-storage", "plugins.scale", "plugins.wild-tangent", "plugins.branding.splash", "game.entities.branding-logo-placeholder",
  ...
  MyGame = ig.Game.extend({
    ...
    getStorageSettings: function() {
      null != this.io.storageGet("COV-settings") &&
        (this.settingsGame = this.io.storageGet("COV-settings"));
      null != this.io.storageGet("COV-CardSettings") && (this.arrayCardInHand = this.io.storageGet("COV-CardSettings"))
    },
    finalize: function() {
      if (ig.ua.mobile) {
        var b = ig.domHandler.getElementById("#play");
    ...
    hideOverlay: function(b) {
      for (i = 0; i < b.length; i++) $("#" +
        b[i]) && $("#" + b[i]).hide(), document.getElementById(b[i]) && (document.getElementById(b[i]).style.visibility = "hidden")
    },
    currentBGMVolume: 1,
    addition: 0.1,
    update: function() {
    ...
    drawDebug: function() {
      if (!ig.global.wm && (this.debugEnable(), this.viewDebug && (ig.system.context.fillStyle = "#000000", ig.system.context.globalAlpha = 0.35, ig.system.context.fillRect(0, 0, ig.system.width / 4, ig.system.height), ig.system.context.globalAlpha = 1, this.debug && 0 < this.debug.length)))
        for (i = 0; i < this.debug.length; i++) ig.system.context.font = "10px Arial", ig.system.context.fillStyle = "#ffffff", ig.system.context.fillText(this.debugLine - this.debug.length +
          i + ": " + this.debug[i], 10, 50 + 10 * i)
    },
    debugCL: function(b) {
...
(function(b, c, d, e, g, j, t) {
  ...
  b[g].l = 1 * new Date;
  j = c.createElement(d);
  t = c.getElementsByTagName(d)[0];
  j.async = 1;
  j.src = e;
  t.parentNode.insertBefore(j, t)
})(window, document, "script", "//www.google-analytics.com/analytics.js", "ga");
ga("create", "UA-73655456-17", {
  name: "marketjs"
});
